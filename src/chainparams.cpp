...
//        //end*/
        ...
        vSeeds.push_back(CDNSSeedData("nodea.litecoinbolt.net", "nodea.litecoinbolt.net"));
        vSeeds.push_back(CDNSSeedData("nodeb.litecoinbolt.net", "nodeb.litecoinbolt.net"));
        vSeeds.push_back(CDNSSeedData("nodec.litecoinbolt.net", "nodec.litecoinbolt.net"));
